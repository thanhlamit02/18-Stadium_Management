...
namespace GUILayer.ChildForm
{
    public partial class FormThongKe : Form
    {
        ...
        private void ThongKeThangVaHomNay()
        {
            ...
            lblHoaDonThang.Text = _billMonth.ToString("N0");
            lblHoaDonHomNay.Text = _billToday.ToString("N0");
            lblKhachHangThang.Text = _cusMonth.ToString("N0");
            lblKhachHangHomNay.Text = _cusToday.ToString("N0");
            lblDoanhThuThang.Text = _saleMonth.ToString("N0");
            lblDoanhThuHomNay.Text = _saleToday.ToString("N0");
        }
        ...
        /* public double formatMoney(double moneyDefautl)
         {
             string formattedAmount = string.Format("{0:#,##0} VND", moneyDefautl);
             return moneyDefautl;
         }*/
